...
{
    public sealed class TvCreatorViewModel : TgaViewModel
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="TvCreatorViewModel"/>
        /// </summary>
        public TvCreatorViewModel(GameConsole console, IDialogService fileDialogService, IDialogService previewDialogService, IMetadataService metadataService, ExceptionViewModel exception)
        ...
        {
            await metadataService.GenerateTvPreviewAsync(SourceFileLocation, _overlay ? _selectedStyle : null, _name1, _name2, _year, _players);
            return metadataService.TvPreview;
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected override async Task<string> DoSaveProcessedFileWorkAsync() => await metadataService.SaveTvTgaAsync();
